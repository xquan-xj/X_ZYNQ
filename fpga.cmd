...
if "%~1"=="" (
  ...
  echo   .\fpga validate ^<project_path^>
  echo   .\fpga create ^<project_path^>
  echo   .\fpga sim ^<project_path^>
  echo   .\fpga synth ^<project_path^>
  echo   .\fpga bitstream ^<project_path^>
  echo   .\fpga gui ^<project_path^>
  echo   .\fpga clean ^<project_path^>
  exit /b 1
)
